...
class JewelleryDomain implements Domain {
  @override String get id => 'jewellery'; @override String get name => 'Jewellery'; @override String get shortLabel => 'GOLD';
  @override List<DomainOperation> get operations => [JewelleryPriceOp(), MakingChargeOp()];

  // JEWEL PRICE: Weight Purity Rate → Total Price
  class JewelleryPriceOp implements DomainOperation {
  @override String get id => 'jew_price'; @override String get label => 'GOLD$'; @override int get arity => 3;
  ...
  final purity = newStack.removeLast().value / Decimal.fromInt(1000); // 24k=240
  ...
  @override String get id => 'making'; @override String get label => '+MC%'; @override int get arity => 2;
  @override RpnStackState execute(RpnStackState state) {
  final newStack = List<CalcNumber>.from(state.stack);
