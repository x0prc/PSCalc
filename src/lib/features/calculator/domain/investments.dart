...
class CagrOp implements DomainOperation {
  @override String get id => 'cagr'; 
  @override String get label => 'CAGR%'; 
  @override int get arity => 3;
  @override String? get description => 'Compound Annual Growth Rate %';
...
class XirrApproxOp implements DomainOperation {
  @override String get id => 'xirr'; 
  @override String get label => 'XIRR%'; 
  @override int get arity => 3;
  @override String? get description => 'XIRR approximation (irregular CFs)';
...
class SharpeRatioOp implements DomainOperation {
  @override String get id => 'sharpe'; 
  @override String get label => 'SHARPE'; 
  @override int get arity => 3;
  @override String? get description => 'Sharpe Ratio (Return Rf Vol → Sharpe)';
...
class MaxDrawdownOp implements DomainOperation {
  @override String get id => 'max_dd'; 
  @override String get label => 'MDD%'; 
  @override int get arity => -1; // variable
  @override String? get description => 'Max Drawdown % (prices → MDD%)';
...
class PortfolioWeightOp implements DomainOperation {
  @override String get id => 'port_weight'; 
  @override String get label => 'WT%'; 
  @override int get arity => 2;
  @override String? get description => 'Portfolio weight %';
  ...
  RpnStackState execute(RpnStackState state) {
    ...
    final weight = ((value / total) * Decimal.fromInt(100)).toDecimal();
